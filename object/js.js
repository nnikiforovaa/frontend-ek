quizlet = {
    question_arr: ['1) Що з переліку НЕ належить до форм фінансової звітності?', '2) Що НЕ належить до принципів фінансового аналізу?', '3) За методом дослідження фінансовий аналіз буває…',
    ...
    a1_arr: ['Звіт про фінансові результати', 'Науковість', 'Трендовий', 'Принцип підбору даних', 'Зовнішній, внутрішній', 'Виробничий', 'Більше 0,5', 'Власного капіталу і зобов’язань', 'Ліквідаційна вартість', 'Адативної формули'],
    a2_arr: ['Звіт про рух грошових коштів', 'Оперативність', 'Мультиплікативний', 'Принцип об’єктивності', 'Кратний, адативний', 'Прямолінійний', 'Менше 0,5', 'Резервного і основного капіталу', 'Зношування', 'Мультиплікативної формули'],
    a3_arr: ['Звіт про зобов\'язання та оборотні активи', 'Cистемність', 'Адативний', 'Принцип характерності', 'Вертикальний, горизонтальний', 'Стохастичний', 'Дорівнювати 0,5', 'Активів і пасивів', 'Загальна амортизація', 'Комбінованої формули'],
    a4_arr: ['Звіт про сукупні доходи', 'Фундаментальність', 'Тематичний', 'Принцип фондоозброєності', 'Прямий, непрямий', 'Кумулятивний', 'Від -0,5 до 0,5', 'Активів, пасивів і основного капіталу', 'Збиткова вартість', 'Кратної формули'],
    answer_arr:['Звіт про зобов\'язання та оборотні активи', 'Фундаментальність', 'Трендовий', 'Принцип підбору даних', 'Прямий, непрямий', 'Стохастичний', 'Більше 0,5', 'Власного капіталу і зобов’язань', 'Зношування', 'Кратної формули'],
